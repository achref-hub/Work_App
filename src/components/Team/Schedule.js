    ...
    <AppointmentTooltip.Header {...restProps} appointmentData={appointmentData}>
        <div className={classes.tooltipHeader} >
          ...
          {/* <Link to={{
           ...
           { appointmentData.title === "WFH" &&  <EditIcon  htmlColor="#767676" onClick={toggleDrawer('left', true, appointmentData)} />}
         {/* </Link> */}
        </div>
    ...
    <Appointments.AppointmentContent {...restProps}>
        <div className={restProps.container}>
              ...
              > 
                  ...
                  {(restProps.data.status === "accepted" || restProps.data.status === "ACTIVE") &&  <span style={{height: '7px',
                                                                          width: '7px',
