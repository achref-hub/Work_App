...
function App() {
    ...
    return (
        <Switch>
                ...
                {token && ( <Route exact path="/leaves" component={Leaves} /> )}
                {token && ( <Route exact path="/validator" component={Validator} /> )}
                ...
                {token && ( <Route exact path="/LeaveDetails/:id" component={LeaveDetails} /> )}
                {token && ( <Route exact path="/ValidatorDetails/:id" component={ValidatorDetails} /> )}
