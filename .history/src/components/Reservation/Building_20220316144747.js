            ...
            floor[0] && floor[0].map((item) => {
                ...
                return (
                    ...
                    //  console.log('iteem', item.floor_map_web) 
                     <div className='plan-floor' dangerouslySetInnerHTML={{ __html: item.floor_map_web_active}} />
                    : <div className='plan-floor' dangerouslySetInnerHTML={{ __html: item.floor_map_web}} />
                )
