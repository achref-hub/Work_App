    ...
    return (
        <>
            ...
            {/* <Card className="card-width">
                <CardRow>
                    <CardHeader color="indigo" size="sm" iconOnly>
                        { props.name === 'Sick' && <Sick fontSize="large" htmlColor="#ffffff" /> } 
                        { props.name === 'Telework' && <HomeWork fontSize="large" htmlColor="#ffffff" /> }
                        { props.name === 'Casual' && <BeachAccess fontSize="large" htmlColor="#ffffff" /> }
                        { props.name === 'Compensatory' && <Cached fontSize="large" htmlColor="#ffffff" /> }
                    </CardHeader>
                    <CardStatus title={props.date}  />                                        
                ...
                <CardFooter>
                    <Label className="mt-5" color={props.color}>{props.status}</Label>
                </CardFooter>
