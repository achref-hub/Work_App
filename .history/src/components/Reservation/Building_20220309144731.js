...
export default function Building(){
    ...
    const green={ 'x1':"0.0147055", 'y1':"1060" ,'x2':"268.015", 'y2':"1061.97", 'stroke':"#CFCFCF" ,'stroke-width':"4"}
    const color = styled.green
    return(
    <div>
        <svg width={1000} height={800} fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1857 1804" >
        {(floors?.floor_num  === '00')?<Floor0 props={green.stroke}  /> : <p></p>}
            <Floor1/>
            <Floor2/>
            <Floor3 />
            <Floor4/>
