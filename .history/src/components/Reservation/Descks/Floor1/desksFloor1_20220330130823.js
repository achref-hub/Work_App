...
export default function DesksFloor1(){
    ...
    //     console.log(result)
    // }, []);
    const socket = openSocket("https://demo.workpoint.tn/api/", {
        transports: ["websocket", "polling", "flashsocket"],
    });

    const getData = desks_data => {
        console.log(desks_data ,"aaaaaaaaa");
        setDesks(desks_data)
    };
    ...
    return (
        <div>
            <svg className='plan' viewBox="0 0 1000 800" fill="none" >
                <FloorPlan1 />
                {
