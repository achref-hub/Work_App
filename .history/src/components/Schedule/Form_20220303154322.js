...
export default function Form() {
  ...
  const toggleDrawerres = (anchor, open, name) => (event) => {
    ...
    <div>
           ...
           position: 'absolute', bottom: 19, right: 90 
            ...
            >
                ...
                <SpeedDialAction
                    ...
                    onClick={toggleDrawerres('left', true, actionres.name)}
                    // FabProps={{ style: { color: "#294e87" } }}
        ...
        <React.Fragment key={'left'}>
          ...
          <SwipeableDrawer
            ...
            onClose={toggleDrawerres('left', false)}
            onOpen={toggleDrawerres('left', true)}
