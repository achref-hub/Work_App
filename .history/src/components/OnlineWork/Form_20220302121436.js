  ...
  export default function Form() {
    ...
    useEffect( async () => {
      ...
      useEffect( async () => {
        ...
        setUsers(users)
        user.manager && setSelected(result.find( item => item._id  === user.manager._id) )        const data = await fetchBalances(token)
      ...
      useEffect( async () => {
        ...
        const balances = await fetchUserBalances(token, user.id)
                        ...
                        <div className="flex-auto p-5 lg:p-10">
                            <div className="w-full text-center">
                                ...
                                <Paragraph color="blueGray">
                                    Complete this form to send a WFH's request1.
                                </Paragraph>
                            </div>
                                ...
                                
                            {
                                                         ...
                                                         <div  className="flex gap-8">
                                                            ...
                                                            <ToggleButtonGroup
                                                                ...
                                                                >
                                                                        ...
                                                                        <ToggleButton value="AM" disabled>
                                                                            <p htmlColor="#083985">AM</p>
                                                                        </ToggleButton>
                                                                        <ToggleButton value="PM" disabled>
                                ...
                                <div className="flex gap-8 mt-16" >
                                    {/* <div className='w-150' >
                                        <Typography  className=" text-sm  text-gray-700 pt-1">Period</Typography>
                                    </div> */}
